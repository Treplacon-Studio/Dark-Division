...
namespace DistantLands.Cozy.Data
{
    ...
    public class PerennialProfile : ClimateProfile
    {
        ...
        public TimeBlock dayBlock = new TimeBlock(9f / 24f, 10f / 24f);
    ...
    public class E_PerennialProfile : Editor
    {
        ...
        public void OnStaticMeasureGUI(GUIStyle style, ref bool lengthWindow, ref bool movementWindow, ref bool timeBlocksWindow, ref bool curveWindow)
        {
            ...
            if (timeBlocksWindow)
            {
                ...
                EditorGUI.indentLevel++;
                start = serializedObject.FindProperty("dawnBlock").FindPropertyRelative("start").floatValue * prof.ticksPerDay;
                end = serializedObject.FindProperty("dawnBlock").FindPropertyRelative("end").floatValue * prof.ticksPerDay;
