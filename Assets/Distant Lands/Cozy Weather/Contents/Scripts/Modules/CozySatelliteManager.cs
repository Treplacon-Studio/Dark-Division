    ...
    public class CozySatelliteManager : CozyModule
    {
        ...
        public void InitializeSatellite(SatelliteProfile sat, bool mainMoon)
        {
            ...
            if (sat.useLight)
            {
                ...
                if (sat.flare)
                {
                    LensFlareComponentSRP flare = obj.AddComponent<LensFlareComponentSRP>();
                    flare.lensFlareData = sat.flare;
        ...
        void Reset()
        {
            ...
            profiles.Add(Resources.Load("Profiles/Satellites/Cutout Moon") as SatelliteProfile);
