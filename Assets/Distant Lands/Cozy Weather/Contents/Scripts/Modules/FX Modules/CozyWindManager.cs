...
namespace DistantLands.Cozy
{
    ...
    public class CozyWindManager : CozyFXModule
    {
        ...
        private float m_WindChangeSpeed;
        ...
        public float windChangeSpeed { get { return m_WindChangeSpeed; } }

        public float windSpeed { get { return m_WindSpeed; } }
        public float windAmount { get { return m_WindAmount; } }
        ...
        public void CalculateWind()
        {
            ...
            if (!Application.isPlaying)
            {
                ...
                m_WindChangeSpeed = defaultWind.windChangeSpeed;
            ...
            else
            {
                ...
                foreach (WindFX j in windFXes)
                {
                    if (j.weight > 0)
                    {
                        ...
                        m_WindChangeSpeed += j.windChangeSpeed * j.weight;
        ...
        public void ManageWind()
        {
            ...
            float i = 360 * Mathf.PerlinNoise(m_Seed, Time.time * m_WindChangeSpeed / 100000);
        ...
        public override void OnFXDisable()
        {
            ...
            if (windZone && generateWindzoneAtRuntime)
                MonoBehaviour.DestroyImmediate(windZone.gameObject);
